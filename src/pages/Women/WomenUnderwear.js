...
const products = [
  ...
  { id: 3, title: "Название товара 3", desc: "Описание товара 3", price: 0, oldPrice: 0, season: "", images: [img7, img8, img9], discount: false },
  { id: 4, title: "Название товара 4", desc: "Описание товара 4", price: 0, oldPrice: 0, season: "", images: [img10, img11, img12], discount: false },
...
export default function WomanUnderwear() {
  ...
  const prevImg = (idx) => {
    setSliderIndexes((prev) => {
      const arr = [...prev];
      arr[idx] =
        (arr[idx] - 1 + filtered[idx].images.length) %
        filtered[idx].images.length;
      return arr;
    });
  };
  ...
  return (
    <div className="page-container">
      ...
      <div
        className={`filters-row${filtersOpen ? " open" : ""}`}
      ...
      >
        ...
        >
          <input
            ...
            style={{ accentColor: "#c4fa08", width: 18, height: 18 }}
          />
          Только со скидкой
        </label>
      </div>
      <div className="cards-row">
        {filtered.length === 0 ? (
          <div style={{ color: "#888", fontSize: "1.2em", marginTop: 40 }}>
          ...
          filtered.map((product, idx) => (
            <div className="product-card" key={product.id}>
              ...
              >
                <img
                  src={product.images[sliderIndexes[idx]]}
                  alt={product.title}
                  ...
                  {product.images.map((_, i) => (
                    <span
                      ...
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          sliderIndexes[idx] === i ? "#c4fa08" : "#ccc",
