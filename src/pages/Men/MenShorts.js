...
const products = [
  ...
  { id: 50, title: "Название товара 50", desc: "Описание товара 50", price: 15000, oldPrice: 26000, season: "", images: [img1, img2, img3], discount: true },
];

const seasons = ["все", "зима", "весна", "лето", "осень"];


export default function MenhShorts() {
